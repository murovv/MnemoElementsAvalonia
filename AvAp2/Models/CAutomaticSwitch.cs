...
namespace AvAp2.Models
{
    ...
    public class CAutomaticSwitch :  BasicCommutationDevice
    {
        ...
        public override void Render(DrawingContext drawingContext)
        {
            ...
            //  drawingContext.PushPostTransform(new RotateTransform(Angle, 15, 15));
            ...
            else if (state == CommutationDeviceStates.UnDefined)
            {
                ...
                var formattedText = new FormattedText("?", typeface, 16, TextAlignment.Center, TextWrapping.NoWrap, Size.Infinity);
